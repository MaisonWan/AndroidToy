 ...
 * 
 * @author maisonwan
 * @date 2014-2-21 下午4:22:51
 * 
 */
public class LayerColorBurn implements LayerBlendable {

	/*
	 * (non-Javadoc)
	 * 
	 * @see
	 * com.tencent.test.image.BitmapLayerBlending.LayerBlendable#pixelCalc(int,
	 * int)
	 */
	@Override
	public int pixelCalc(int down, int up) {
		return down == 0 ? down : Math.max(0, (255 - ((255 - up) << 8) / down));
	}
