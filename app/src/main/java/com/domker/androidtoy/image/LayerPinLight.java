 ...
 * TODO
 * @author maisonwan
 * @date 2014-2-21 下午4:56:03
 *
 */
public class LayerPinLight implements LayerBlendable {
	...
	public int pixelCalc(int down, int up) {
		return Math.max(0, Math.max(2 * up - 255, Math.min(down, 2 * up)));
	}
