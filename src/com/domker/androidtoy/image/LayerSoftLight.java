 ...
 * TODO
 * @author maisonwan
 * @date 2014-2-21 下午4:50:32
 *
 */
public class LayerSoftLight implements LayerBlendable {
	...
	public int pixelCalc(int down, int up) {
		return down < 128 ? (2 * ((up >> 1) + 64)) * (down / 255) : (255 - (2
				* (255 - ((up >> 1) + 64)) * (255 - down) / 255));
	}
