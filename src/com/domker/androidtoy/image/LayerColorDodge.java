 ...
 * TODO
 * @author maisonwan
 * @date 2014-2-21 下午4:42:27
 *
 */
public class LayerColorDodge implements LayerBlendable {
	...
	public int pixelCalc(int down, int up) {
		return down == 255 ? down : Math.min(255, ((up << 8) / (255 - down)));
	}
